    ...
    return (
      <>
        <div className="--header-home-main">
            ...
            <Link  to='/home'><img src={Logo} alt="BeatShop"></img></Link>
            <Link className='--header-h1-link' to='/home'><h1>BeatStore</h1></Link>   
            </div>
            ...
            {STORE_USER.user && STORE_USER.user.data
                ?(
                    <ul> 
                        <span className='--header-flags' onClick={() => changeLanguage('en')}><img src={flagEN} alt="flagENGLISH" /></span>
                        <span className='--header-flags' onClick={() => changeLanguage('es')}><img src={flagSP}alt="flagSPANISH" /></span> 
                       <li>
                         ...
                         {shortenText(STORE_USER.user.data.user.name) || STORE_USER.user.data.user.email}
                          ...
                          <div className="--header-home-cart">
                            {STORE_USER.user.data.user.image ?(
                              <>
                              <span className="--user-imgProfile"> <img src={`${serverUrl}/images/${STORE_USER.user.data.user.image}`} alt='imageProfile'/>  </span>
                    ...
                    <ul>
                        <li className='--header-flags' onClick={() => changeLanguage('en')}><img src={flagEN} alt="flagENGLISH" /></li>
                        <li className='--header-flags' onClick={() => changeLanguage('es')}><img src={flagSP} alt="flagSPANISH" /></li>
