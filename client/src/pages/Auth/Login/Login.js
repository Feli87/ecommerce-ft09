...
import {animationThree, transition} from '../../../Transitions/Transitions';
...
const Login = ({t}) => {
    ...
    return(
        ...
        >
            <div className='--title-invisibility-login'>
                <Link className="--login-logo-col-linkv2" to='/home'>
            ...
            <div className="--LoginAllCard">
                <div className="--login-logo">
                    ...
                    <div className='--login-flags' onClick={() => changeLanguage('en')}>
                        ...
                        <Link className="--login-logo-col-link" to='/home'>
                            <img className='disable--in--max480' width="60px" height="50px" src={logoIcon} alt=""></img>
                        </Link>
                    </div>
                    <div className="--login-logo-col">
                        <Link className="--login-logo-col-link" to='/home'>
                            <h1 className='disable--in--max480'>BeatStore</h1>
                        </Link>                          
